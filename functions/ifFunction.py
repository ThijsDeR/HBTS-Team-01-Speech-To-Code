        ...
        if self.inlineVoiceFunction == None:
            ...
            if self.currentStep == 0:
                ...
                if "if" in words:
                    self.ifType = "if"
                    print("Chose if")
                    self.SpeakText("Chose if")
                    self.currentStep = 2
                elif "else if" in words:
                    self.ifType = "elif"
                    print("Chose elif")
                    self.SpeakText("Chose elif")
                    self.currentStep = 2
                else:
                    self.ifType = "else"
                    print("Chose else")
                    self.SpeakText("Chose else")
                    self.currentStep = 5
                ...
                if "yes" in words:
                    ...
                    self.currentStep = 8
                    print("are you happy with the if statement? say show to show the if statement (then reply with `yes`, `no`, `add and` or `add or`)")
                    self.SpeakText("are you happy with the if statement? say show to show the if statement (then reply with `yes`, `no`, `add and` or `add or`)")
                    return False
                elif "redo" in words:
                    self.currentStep = 6
                ...
                if "yes" in words:
                    ...
                    if self.ifType != "else":
                        line = writeLine('text.py', f"{self.ifType} {statementString}:\n", self.spacing)
                    else:
